...
Parse.Cloud.define("sendEmailForShift", function(req, res) {
    var params = req.params;
  	var subject = 'Statistic shift from start date time: '+moment(params.startDateTime).format("DD/MM/YYYY HH:mm")+' to end date time: '+moment(params.endDateTime).format("DD/MM/YYYY HH:mm");
